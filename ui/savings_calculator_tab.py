#!/usr/bin/env python3
"""
Savings Calculator Tab for Financial Tools Calculator
Contains all the savings calculation functionality
"""
...
class SavingsCalculatorTab:
    ...
    def create_tab(self):
        """Create the Savings Calculator tab"""
        self.savings_frame = ttk.Frame(self.parent_notebook)
        self.parent_notebook.add(self.savings_frame, text="Savings Calculator")
        
        # Create horizontal split frame for savings calculator
        split_frame = ttk.PanedWindow(self.savings_frame, orient=tk.HORIZONTAL)
        ...
        # Buttons frame
        button_frame = ttk.Frame(self.savings_frame)
        ...
        self.savings_frame.after(100, self.auto_calculate)
    ...
    def on_parameter_change(self, event=None):
        ...
        if hasattr(self, '_calculation_timer'):
            self.savings_frame.after_cancel(self._calculation_timer)
        
        # Reduce delay to 300ms for more responsive updates
        self._calculation_timer = self.savings_frame.after(300, self.auto_calculate)
